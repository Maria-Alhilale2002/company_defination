...
<body>
    ...
    <div class="admin-simple-container">
        ...
        <div class="edit-form-container">
            <form class="edit-form" method="POST" action="{{ route('about.update', $about->id ?? 1) }}">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <textarea 
                        ...
                        required
                    >{{ old('about_text', $about->about_text ?? '') }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    >{{ old('message_text', $about->message_text ?? '') }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    >{{ old('story_text', $about->story_text ?? '') }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    >{{ old('principle_text', $about->principle_text ?? '') }}</textarea>
                </div>
