        ...
        <form action="{{ route('admin.products.update', $product->product_id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="service-type-grid">
                    <div class="service-type-option">
                        <input type="radio" id="website" name="service_type" value="website" {{ old('service_type', $product->service_type) == 'website' ? 'checked' : '' }}>
                    ...
                    <div class="service-type-option">
                        <input type="radio" id="app" name="service_type" value="app" {{ old('service_type', $product->service_type) == 'app' ? 'checked' : '' }}>
                    ...
                    <div class="service-type-option">
                        <input type="radio" id="digital_marketing" name="service_type" value="digital_marketing" {{ old('service_type', $product->service_type) == 'digital_marketing' ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea id="product_description" 
                          ...
                          placeholder="اكتب وصفاً مفصلاً عن المنتج والخدمات المقدمة...">{{ old('product_description', $product->product_description) }}</textarea>
