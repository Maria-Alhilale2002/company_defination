    ...
    <div class="admin-simple-container">
        ...
        <div class="admin-page-header">
            ...
            <div style="display: flex; gap: 1rem; align-items: center;">
                ...
                <a href="{{ route('admin.products.create') }}" style="display: inline-flex; align-items: center; gap: 8px; padding: 10px 20px; background: #28a745; color: white; text-decoration: none; border-radius: 10px; font-weight: 600; transition: all 0.3s ease;">
                ...
                <tbody>
                    @forelse($products as $index => $product)
                        <tr>
                            ...
                            <td>
                                <span class="service-type type-{{ $product->service_type }}">
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('admin.products.edit', $product->product_id) }}" class="btn-edit" title="تعديل">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button class="btn-delete" onclick="deleteProduct({{ $product->product_id }}, '{{ $product->product_name }}')" title="حذف">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" style="text-align: center; padding: 40px; color: #999;">
                                ...
                                <br>
                                <a href="{{ route('admin.products.create') }}" style="color: var(--primary-color); text-decoration: none; margin-top: 10px; display: inline-block;">
