...
<body>
    ...
    <script>
        ...
        // دالة تبديل حالة العميل المميز
        function toggleFeatured(clientId, clientName, isFeatured) {
            const token = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
            
            // إنشاء نموذج وإرساله
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = `/admin/clients/${clientId}/toggle-featured`;
