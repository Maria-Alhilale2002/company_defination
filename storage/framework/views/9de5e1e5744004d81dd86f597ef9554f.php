...
<head>
    ...
    <title>تعديل المنتج - تك رووت</title>
            ...
            <div class="form-group">
                ...
                <div class="service-type-grid">
                    <div class="service-type-option">
                        <input type="radio" id="website" name="service_type" value="website" <?php echo e(old('service_type', $product->service_type) == 'website' ? 'checked' : ''); ?>>
                    ...
                    <div class="service-type-option">
                        <input type="radio" id="app" name="service_type" value="app" <?php echo e(old('service_type', $product->service_type) == 'app' ? 'checked' : ''); ?>>
                    ...
                    <div class="service-type-option">
                        <input type="radio" id="digital_marketing" name="service_type" value="digital_marketing" <?php echo e(old('service_type', $product->service_type) == 'digital_marketing' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                          placeholder="اكتب وصفاً مفصلاً عن المنتج والخدمات المقدمة..."><?php echo e(old('product_description', $product->product_description)); ?></textarea>
            ...
            <div class="form-group">
                ...
                <?php if($product->product_image): ?>
                    <div class="current-image">
                        ...
                        <img src="<?php echo e(asset($product->product_image)); ?>" alt="<?php echo e($product->product_name); ?>">
                        <p style="margin-top: 10px; color: #94a3b8; font-size: 0.9rem;">اختر صورة جديدة لتحديث الصورة الحالية</p>
                    </div>
                <?php endif; ?>
        ...
        function previewImage(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    fileText.textContent = 'تم اختيار الصورة الجديدة بنجاح';
                }
                ...
                const fileText = fileDisplay.querySelector('.file-input-text h4');
                fileText.textContent = 'اختر صورة جديدة (اختياري)';
            }
        }
...
<?php /**PATH C:\Users\Aseel Online\example-app\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>