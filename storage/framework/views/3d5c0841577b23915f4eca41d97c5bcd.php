    ...
    <section id="home" class="hero">
        <div class="hero-container">
            <div class="hero-content">
                <h1 class="hero-title">
                    <span class="title-line"><?php echo e($home->main_text ?? 'نحول أفكارك إلى'); ?></span>
                    <span class="title-highlight"><?php echo e($home->next_text ?? 'حلول رقمية متكاملة'); ?></span>
                </h1>
                <p class="hero-description">
                    <?php echo e($home->description_text ?? 'شركة رائدة في مجال البرمجيات والتطوير، نقدم خدمات متميزة في برمجة المواقع والتطبيقات والتسويق الرقمي'); ?>
...
<?php echo $__env->make('layout.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Aseel Online\example-app\resources\views/index.blade.php ENDPATH**/ ?>