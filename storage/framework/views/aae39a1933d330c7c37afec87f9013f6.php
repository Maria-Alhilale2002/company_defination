            ...
            <div class="services-grid">
                ...
                <div class="service-card" data-aos="fade-up">
                    ...
                    <p class="service-description">
                         <?php echo e($service->service_description_web ?? 'websites...'); ?>                    </p>
                ...
                <div class="service-card" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="service-description">
                         <?php echo e($service->service_description_app ?? 'application...'); ?>                    </p>
                    </p>
                    <ul class="service-features">
                ...
                <div class="service-card" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="service-description">
                         <?php echo e($service->service_description_marketing ?? 'marketing...'); ?>                    </p>
                    </p>
                    <ul class="service-features">
...
<?php echo $__env->make('layout.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Aseel Online\example-app\resources\views/services.blade.php ENDPATH**/ ?>