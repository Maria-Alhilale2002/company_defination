     ...
     <?php $__env->startSection('title','التواصل'); ?>
        ...
        <div class="container">
            <div class="contact-wrapper">
                <div class="form-side" data-aos="fade-right">
                    ...
                    <form class="contact-form" id="contactForm" method="post" action="<?php echo e(route('send')); ?>">
...
<?php echo $__env->make('layout.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Aseel Online\example-app\resources\views/contact.blade.php ENDPATH**/ ?>